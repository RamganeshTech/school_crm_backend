...
// ---------- UPDATE (text fields + statutory document files, merged) ----------
...
//     if (operationalStatus !== undefined) bus.operationalStatus = operationalStatus;

//     const files = (req.files as any[]) || [];

//     // merge statutory documents metadata + append any newly uploaded files (statutoryDocuments_<index>)
//     if (statutoryDocuments !== undefined) {
//       const documentsPayload: any[] =
//         typeof statutoryDocuments === "string" ? JSON.parse(statutoryDocuments) : statutoryDocuments;

//       const mergedDocuments = await Promise.all(
//         documentsPayload.map(async (doc: any, index) => {
//           const existing = doc._id
//             ? bus.statutoryDocuments.find((d: any) => String(d._id) === String(doc._id))
//             : null;
...
//       bus.statutoryDocuments = mergedDocuments as any;
//     }
